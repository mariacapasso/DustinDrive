...
class DeviceAdapter (
    ...
    var connectedAddress: String? = null
        ...
        class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
           ...
           val disconnetti: Button = itemView.findViewById(R.id.disconnettibtn)
           val stato: TextView = itemView.findViewById(R.id.dispositivo_connesso_txt)
            val chevron: ImageView = itemView.findViewById(R.id.iconaChevron)
       }
    ...
    fun updateList(newDevices: List<BluetoothDevice>) {
        devices.clear()
        devices.addAll(newDevices.sortedByDescending { it.address == connectedAddress })
